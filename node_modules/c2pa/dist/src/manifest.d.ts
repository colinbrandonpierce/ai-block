...
import { CawgReport, VerifiedIdentity } from './lib/cawg';
 ...
 */
export declare function createManifest(manifestData: ToolkitManifest, manifests: ManifestMap, cawgData: CawgReport): Manifest;
export {};
